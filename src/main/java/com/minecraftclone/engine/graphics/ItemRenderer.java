...
public class ItemRenderer {
    ...
    private void addBillboard(FloatArray verts, IntArray inds, int[] counter, ItemEntity e, float[] uv) {
        ...
        verts.add(p.x - rx); verts.add(cy - HALF_SIZE); verts.add(p.z - rz); verts.add(u0); verts.add(v1); verts.add(1f); verts.add(0f);
        verts.add(p.x + rx); verts.add(cy - HALF_SIZE); verts.add(p.z + rz); verts.add(u1); verts.add(v1); verts.add(1f); verts.add(0f);
        verts.add(p.x + rx); verts.add(cy + HALF_SIZE); verts.add(p.z + rz); verts.add(u1); verts.add(v0); verts.add(1f); verts.add(0f);
        verts.add(p.x - rx); verts.add(cy + HALF_SIZE); verts.add(p.z - rz); verts.add(u0); verts.add(v0); verts.add(1f); verts.add(0f);
