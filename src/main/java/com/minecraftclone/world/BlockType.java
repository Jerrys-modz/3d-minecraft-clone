...
public enum BlockType {
    ...
    // --- GTNH Ores: 15 ore types × 4 stages (ore, crushed, dust, ingot) ---
    // Early game ores
    COPPER_ORE(138, true, false, 4, 4, 4),
    CRUSHED_COPPER(139, true, false, 4, 4, 4),
    COPPER_DUST(140, true, false, 4, 4, 4),
    COPPER_INGOT(141, 0),

    TIN_ORE(142, true, false, 4, 4, 4),
    CRUSHED_TIN(143, true, false, 4, 4, 4),
    TIN_DUST(144, true, false, 4, 4, 4),
    TIN_INGOT(145, 0),

    ZINC_ORE(146, true, false, 4, 4, 4),
    CRUSHED_ZINC(147, true, false, 4, 4, 4),
    ZINC_DUST(148, true, false, 4, 4, 4),
    ZINC_INGOT(149, 0),

    LEAD_ORE(150, true, false, 4, 4, 4),
    CRUSHED_LEAD(151, true, false, 4, 4, 4),
    LEAD_DUST(152, true, false, 4, 4, 4),
    LEAD_INGOT(153, 0),

    SILVER_ORE(154, true, false, 4, 4, 4),
    CRUSHED_SILVER(155, true, false, 4, 4, 4),
    SILVER_DUST(156, true, false, 4, 4, 4),
    SILVER_INGOT(157, 0),

    BAUXITE_ORE(158, true, false, 4, 4, 4),
    CRUSHED_BAUXITE(159, true, false, 4, 4, 4),
    BAUXITE_DUST(160, true, false, 4, 4, 4),
    ALUMINUM_INGOT(161, 0),

    // Mid game ores (gold/iron reuse existing ore blocks)
    CRUSHED_GOLD(162, true, false, 4, 4, 4),
    GOLD_DUST(163, true, false, 4, 4, 4),

    NICKEL_ORE(164, true, false, 4, 4, 4),
    CRUSHED_NICKEL(165, true, false, 4, 4, 4),
    NICKEL_DUST(166, true, false, 4, 4, 4),
    NICKEL_INGOT(167, 0),

    COBALT_ORE(168, true, false, 4, 4, 4),
    CRUSHED_COBALT(169, true, false, 4, 4, 4),
    COBALT_DUST(170, true, false, 4, 4, 4),
    COBALT_INGOT(171, 0),

    TUNGSTEN_ORE(172, true, false, 4, 4, 4),
    CRUSHED_TUNGSTEN(173, true, false, 4, 4, 4),
    TUNGSTEN_DUST(174, true, false, 4, 4, 4),
    TUNGSTEN_INGOT(175, 0),

    CRUSHED_IRON(176, true, false, 4, 4, 4),
    IRON_DUST(177, true, false, 4, 4, 4),

    // Late game ores
    PLATINUM_ORE(178, true, false, 4, 4, 4),
    CRUSHED_PLATINUM(179, true, false, 4, 4, 4),
    PLATINUM_DUST(180, true, false, 4, 4, 4),
    PLATINUM_INGOT(181, 0),

    IRIDIUM_ORE(182, true, false, 4, 4, 4),
    CRUSHED_IRIDIUM(183, true, false, 4, 4, 4),
    IRIDIUM_DUST(184, true, false, 4, 4, 4),
    IRIDIUM_INGOT(185, 0),

    MANGANESE_ORE(186, true, false, 4, 4, 4),
    CRUSHED_MANGANESE(187, true, false, 4, 4, 4),
    MANGANESE_DUST(188, true, false, 4, 4, 4),
    MANGANESE_INGOT(189, 0),

    CRUSHED_DIAMOND(190, true, false, 4, 4, 4),
    DIAMOND_DUST(191, true, false, 4, 4, 4);
