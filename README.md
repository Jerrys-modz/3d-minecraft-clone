...
- **Villages**: occasional clusters of a few flat-roofed houses around a stone well, built on a flattened plaza. They spawn in buildable lowland biomes (plains, desert, savanna, taiga, tundra, flower meadow, cherry grove) and can span several chunks - each chunk builds its own slice of a nearby village as you approach it.
