...
- **Procedural terrain generation**: layered Perlin/fBm noise for continents and oceans (a low-frequency channel creates real ocean basins and landmasses at a natural sea level), rolling hills and real mountain peaks, a **temperature + moisture biome system** that assigns each column a biome (ocean / frozen ocean / beach / plains / forest / desert / savanna / badlands / jungle / taiga / snowy / tundra / swamp / mushroom field / mountain) and drives its surface blocks, trees and ground cover, winding **rivers** carved as wide shallow channels whose banks sit level with the water, 3D-noise cave systems with lava pooling in the deepest pockets, and four depth-gated ore veins (coal, iron, gold, diamond - rarer ones deeper and sparser, mirroring vanilla Minecraft's progression). Water only forms in bodies that connect to a neighbour, so stray 1-2 block puddles never litter the landscape.
- **Biome-varied vegetation**: dense oak forests and tall grass/flowers/berry bushes where it's wet, sparser oak on plains, tall jungle trees hung with vines in the hot wet jungle, conical pine trees in cold taiga and on mountain slopes, cacti and dried dead bushes in deserts and badlands, dead swamp trees, red/brown mushrooms on rare mycelium fields, sandy beaches that hug only the actual coastline, gravel/sand ocean floors with icy caps on frozen oceans, and the occasional boulder on the plains.
