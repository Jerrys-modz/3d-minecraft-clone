...
- **Crafting**: a small fixed recipe table (logs → planks → sticks, sand → glass, planks/stone/ingots + sticks → tools, stick + coal → torches, glass + torch → lamps, 8 stone → furnace) - press `C` with the output selected in your hotbar and, if you have the ingredients, it's crafted directly into your inventory. No crafting-grid UI needed.
